import { _resolveAndApplyOverrideHandlingOverrides, clientConfigSchema, connectionSchema } from "./types.js";
	...
	*/
	...
	async setLoggingLevel(...args) {
		if (args.length === 1 && typeof args[0] === "string") {
			const level = args[0];
			await Promise.all(this.#clientConnections.getAllClients().map((client) => client.setLoggingLevel(level)));
			return;
		}
...
//#endregion
export { MCPClientError, MultiServerMCPClient };
