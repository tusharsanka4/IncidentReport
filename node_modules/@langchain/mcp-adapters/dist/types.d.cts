...
declare const clientConfigSchema: z.ZodIntersection<z.ZodIntersection<z.ZodIntersection<z.ZodObject<{
  ...
  afterToolCall: z.ZodOptional<z.ZodFunction<z.ZodTuple<[z.ZodObject<{
    ...
    }>, z.ZodType<ContentBlock$1.Multimodal.Standard, z.ZodTypeDef, ContentBlock$1.Multimodal.Standard>]>, "many">], null>, z.ZodType<ToolMessage$1<MessageStructure<import("@langchain/core/messages").MessageToolSet>>, z.ZodTypeDef, ToolMessage$1<MessageStructure<import("@langchain/core/messages").MessageToolSet>>>]>;
  }, "result">, "strip", z.ZodTypeAny, {
    result: string | Command$1<unknown, Record<string, unknown>, string> | ToolMessage$1<MessageStructure<import("@langchain/core/messages").MessageToolSet>> | [string | (ContentBlock$1 | ContentBlock$1.Data.DataContentBlock)[], ({
      type: "resource";
      resource: {
        uri: string;
        mimeType?: string | undefined;
...
//#endregion
export { ClientConfig, type Command$1 as Command, Connection, type ContentBlock$1 as ContentBlock, CustomHTTPTransportOptions, LoadMcpToolsOptions, MCPResource, MCPResourceContent, MCPResourceTemplate, type MessageStructure, Notifications, OutputHandling, type RunnableConfig$1 as RunnableConfig, StdioConnection, StreamableHTTPConnection, type ToolMessage$1 as ToolMessage, clientConfigSchema, connectionSchema, notifications, outputHandlingSchema, stdioConnectionSchema, streamableHttpConnectionSchema };
