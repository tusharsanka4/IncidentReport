...
const notifications = zod_v3.z.object({
	...
	* ```
	*/
	onResourcesUpdated: zod_v3.z.function().args(zod_v3.z.object({ 
	/**
	* The URI of the resource that has been updated. This might be a sub-resource of the one that the client actually subscribed to.
	*/
uri: zod_v3.z.string() }), serverMessageSourceSchema).returns(zod_v3.z.union([zod_v3.z.void(), zod_v3.z.promise(zod_v3.z.void())])).optional(),
	/**
...
exports.oAuthClientProviderSchema = oAuthClientProviderSchema;
exports.outputHandlingSchema = outputHandlingSchema;
exports.stdioConnectionSchema = stdioConnectionSchema;
exports.stdioRestartSchema = stdioRestartSchema;
exports.streamableHttpConnectionSchema = streamableHttpConnectionSchema;
exports.streamableHttpReconnectSchema = streamableHttpReconnectSchema;
