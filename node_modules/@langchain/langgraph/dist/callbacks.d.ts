...
declare const GRAPH_CALLBACK_HANDLER: unique symbol;
/** Loop status at a graph lifecycle transition. */
type GraphLifecycleStatus = "pending" | "done" | "interrupt_before" | "interrupt_after" | "out_of_steps" | "draining";
/** A graph execution resumed from a checkpoint. */
interface GraphResumeEvent {
...
interface GraphInterruptEvent extends GraphResumeEvent {
  readonly interrupts: readonly Interrupt[];
}
type GraphLifecycleEvent = GraphInterruptEvent | GraphResumeEvent;
/**
 ...
 * ```
 */
declare class GraphCallbackHandler extends BaseCallbackHandler {
  name: string;
...
//#endregion
export { GraphCallbackHandler, GraphInterruptEvent, GraphLifecycleEvent, GraphLifecycleStatus, GraphResumeEvent };
