...
* ```
*/
var GraphCallbackHandler = class extends BaseCallbackHandler {
	name = "GraphCallbackHandler";
	[GRAPH_CALLBACK_HANDLER] = true;
	static isInstance(value) {
		return typeof value === "object" && value !== null && GRAPH_CALLBACK_HANDLER in value && value[GRAPH_CALLBACK_HANDLER] === true;
	}
};
//#endregion
export { GraphCallbackHandler };
