...
var Pregel = class extends PartialRunnable {
	...
	*/
	async *_streamIterator(input, options) {
		...
		const dispatchGraphCallbacks = require_callbacks.getGraphCallbackDispatcher(runManager);
		...
		const createAndRunLoop = async () => {
			try {
				loop = await require_loop.PregelLoop.initialize({
					...
					interruptBefore,
					manager: runManager,
					hasGraphCallbacks: dispatchGraphCallbacks !== void 0,
					debug: this.debug,
