...
declare class CallbackManager extends BaseCallbackManager implements BaseCallbackManagerMethods {
  ...
  handleToolStart(tool: Serialized, input: string | Record<string, unknown>, runId?: string, _parentRunId?: string | undefined, _tags?: string[] | undefined, _metadata?: Record<string, unknown> | undefined, runName?: string | undefined, toolCallId?: string | undefined): Promise<CallbackManagerForToolRun>;
