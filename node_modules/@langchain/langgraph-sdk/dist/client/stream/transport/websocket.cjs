...
var ProtocolWebSocketTransportAdapter = class {
	...
	*/
	...
	async open() {
		...
		if (!reconnecting) await this.onConnected?.({
			kind: "initial",
			attempt: 0
		});
	}
	...
	#scheduleReconnect(cause) {
		...
		this.reconnectInFlight = Promise.resolve().then(() => this.#runReconnectLoop(cause)).finally(() => {
