...
var SubmitCoordinator = class {
	...
	*/
	...
	constructor(params) {
		...
		this.#queueAdapter = serverQueueEnabled ? new AgentServerQueueAdapter(params.options.client.runs, params.options.assistantId, params.queueStore, onQueueError, (threadId) => params.ensureThread(threadId, true)) : new LocalQueueAdapter(params.queueStore, onQueueError);
