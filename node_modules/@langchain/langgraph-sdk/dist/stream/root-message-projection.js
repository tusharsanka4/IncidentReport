...
import { buildMessageIndex, messagesEqual, reconcileMessagesFromValues, shouldPreferValuesMessage } from "./message-reconciliation.js";
	...
	*/
	applyValues(nextValues, nextMessages, opts) {
		...
		const reconciliation = reconcileMessagesFromValues({
			...
			preferValuesMessage: (valuesMessage, streamedMessage) => shouldPreferValuesMessage(valuesMessage, streamedMessage, { allowInPlaceMutations: !addOnly }),
			addOnly
		});
