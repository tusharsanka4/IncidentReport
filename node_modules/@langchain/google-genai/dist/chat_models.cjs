...
var ChatGoogleGenerativeAI = class extends _langchain_core_language_models_chat_models.BaseChatModel {
	...
	constructor(modelOrFields, fieldsArg) {
		...
		super(fields);
		this._addVersion("@langchain/google-genai", "2.3.2");
		...
		this.apiKey = fields.apiKey ?? gatewayConfig.apiKey ?? ((0, _langchain_core_utils_env.getEnvironmentVariable)("GOOGLE_API_KEY") || (0, _langchain_core_utils_env.getEnvironmentVariable)("GEMINI_API_KEY"));
	...
	useCachedContent(cachedContent, modelParams, requestOptions) {
		...
		this.client = new _google_generative_ai.GoogleGenerativeAI(this.apiKey).getGenerativeModelFromCachedContent(cachedContent, modelParams, resolvedRequestOptions);
	}
