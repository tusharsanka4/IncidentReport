...
interface EmptyContentErrorParams {
  /**
...
declare const EmptyContentError_base: typeof LangChainError & {
 ...
 * ```
 */
declare class EmptyContentError extends EmptyContentError_base {
...
//#endregion
export { EmptyContentError, EmptyContentErrorParams };
