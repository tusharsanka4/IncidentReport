...
export declare function mergeRuntimeEnvIntoRun<T extends RunCreate | RunUpdate>(run: T, cachedEnvVars?: Record<string, string>, omitTracedRuntimeInfo?: boolean, tracingSampleRate?: number): T;
...
export declare class Client implements LangSmithTracingClientInterface {
    ...
    private _fetchOptionsHeaders;
    private _openAPIClient?;
    private _openAPIClientSignature?;
    private settings;
     ...
     */
    private get _sdkControlledHeaders();
    /**
    ...
    private _maskRunMetadata;
    private _mergeRuntimeEnvAndMaskMetadata;
    ...
    createProject({ projectName, description, metadata, upsert, projectExtra, referenceDatasetId, numExamples, numRepetitions, evaluatorKeys, tagValueIds, }: CreateProjectParams): Promise<TracerSession>;
    ...
    createDataset(name: string, { description, dataType, inputsSchema, outputsSchema, metadata, tagValueIds, }?: {
        description?: string;
        dataType?: DataType;
        inputsSchema?: KVMap;
        outputsSchema?: KVMap;
