 ...
 */
function _resolveOpenAIAgentsLsAgentType(spanData, parentRun, existingTag) {
    if (typeof existingTag === "string" &&
        ls_agent_type_js_1.NON_ROOT_LS_AGENT_TYPES.has(existingTag)) {
        return undefined;
    }
...
class OpenAIAgentsTracingProcessor {
    ...
    async onSpanStart(span) {
        ...
        const structuralTag = _resolveOpenAIAgentsLsAgentType(spanData, parentRun, meta.ls_agent_type);
