...
class _ExperimentManager {
    ...
    constructor(args) {
        ...
        Object.defineProperty(this, "_disableEvaluatorTracing", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    async _runEvaluators(evaluators, currentResults, fields) {
        ...
        for (const evaluator of evaluators) {
            try {
                ...
                const rawEvaluatorResponse = await evaluator.evaluateRun(run, example, options);
                ...
                evaluationResults.results.push(...(await fields.client.logEvaluationFeedback({
                    evaluatorResponse,
                    run,
 ...
 */
function _withoutSourceRunIds(response) {
...
async function wrapSummaryEvaluators(evaluators, optionsArray, tracingEnabled) {
