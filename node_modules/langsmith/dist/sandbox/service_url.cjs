...
exports.ServiceLoginUrl = exports.ServiceUrl = exports.SERVICE_TOKEN_HEADER = void 0;
/** Header the sandbox router reads the minted service token from. */
exports.SERVICE_TOKEN_HEADER = "X-Langsmith-Sandbox-Service-Token";
 ...
 */
class ServiceUrl {
    constructor(data, refresher) {
        Object.defineProperty(this, "_browserUrl", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "_refresher", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    _shouldRefresh() {
        if (!this._refresher || !this._expiresAt)
            return false;
    ...
    async _maybeRefresh() {
        if (!this._refresher || !this._shouldRefresh())
            return;
    ...
    async fetch(path = "/", init = {}) {
        ...
        headers.set(exports.SERVICE_TOKEN_HEADER, await this.token());
...
exports.ServiceLoginUrl = ServiceLoginUrl;
