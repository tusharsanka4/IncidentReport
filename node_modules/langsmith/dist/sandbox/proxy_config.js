...
export function getAwsRoleArn(aws) {
...
export function proxyConfig({ rules, accessControl, } = {}) {
    const config = {
...
export function awsAuth({ accessKeyId, secretAccessKey, roleArn, name = "aws", enabled = true, envVars, }) {
    const candidate = {};
...
export function gcpAuth({ serviceAccountJson, scopes, name = "gcp", enabled = true, envVars, }) {
    const gcp = {
