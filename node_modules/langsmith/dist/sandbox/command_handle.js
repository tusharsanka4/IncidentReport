...
export class CommandHandle {
        ...
        while (true) {
            try {
                ...
                if (this._reconnectAttempts > CommandHandle.MAX_AUTO_RECONNECTS) {
                    throw new LangSmithSandboxConnectionError(`Failed to reattach to the command ${this._reconnectAttempts} times in succession, giving up`);
                }
    ...
    sendInput(data) {
        if (this._stdinClosed) {
            throw new LangSmithSandboxOperationError("stdin is closed for this command. Non-PTY commands close stdin by " +
