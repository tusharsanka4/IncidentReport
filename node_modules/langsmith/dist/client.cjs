...
const sampling_js_1 = require("./utils/sampling.cjs");
...
class Client {
    ...
    static getDefaultClientConfig() {
        ...
        const apiUrlSource = envApiUrl != null
    ...
    get _openAPIClientOptions() {
        ...
        if (!Object.keys(headers).some((name) => name.toLowerCase() === "user-agent")) {
            headers["User-Agent"] = `langsmith-js/${index_js_1.__version__}`;
        }
    ...
    get openAPIClient() {
        ...
        if (this._openAPIClient === undefined ||
    ...
    _shouldSample(identifier) {
        return (0, sampling_js_1.isSampledById)(identifier, this.tracingSampleRate);
    }
    _filterForSampling(runs) {
        // updateRun() may omit trace_id; dotted order's first segment is the root.
        return runs.filter((run) => this._shouldSample(run.trace_id ??
    ...
    async _checkFeedbackSessionId() {
        ...
        const serverInfo = await this._ensureServerInfo();
        if ((0, v2_migration_js_1.getQueryBackend)(serverInfo.instance_flags) === v2_migration_js_1.QueryBackend.SMITHDB_ONLY) {
    ...
    async updateRun(runId, run, options) {
        ...
        const body = (0, index_js_4.serialize)(run.extra
            ? mergeRuntimeEnvIntoRun(run, this.cachedLSEnvVarsForMetadata, this.omitTracedRuntimeInfo, this.tracingSampleRate)
            : run, `Serializing payload to update run with id: ${runId}`);
        await this.caller.call(async () => {
    ...
    async readRun(runId, { loadChildRuns } = { loadChildRuns: false }) {
        (0, warn_js_1.warnOnce)("readRun() is deprecated and will be removed after Jan 31, 2027. " +
            "Use client.runs.retrieve() instead. " +
            "See https://docs.langchain.com/langsmith/smithdb-sdk-migration-runs#runs-retrieve for the migration guide.", { type: "DeprecationWarning", code: "LANGSMITH_DEPRECATED_READ_RUN" });
    ...
    async getRunUrl({ runId, run, projectOpts, }) {
        (0, warn_js_1.warnOnce)("getRunUrl() is deprecated and will be removed after Jan 31, 2027. " +
            "Use client.runs.getURL() instead. " +
            "See https://docs.langchain.com/langsmith/smithdb-sdk-migration-runs#runs-get-url for the migration guide.", { type: "DeprecationWarning", code: "LANGSMITH_DEPRECATED_GET_RUN_URL" });
        if (run !== undefined) {
            let sessionId;
            if (run.session_id) {
    ...
    async *listRuns(props) {
        (0, warn_js_1.warnOnce)("listRuns() is deprecated and will be removed after Jan 31, 2027. " +
            "Use client.runs.query() instead. " +
            "See https://docs.langchain.com/langsmith/smithdb-sdk-migration-query-runs#runs-query for the migration guide.", { type: "DeprecationWarning", code: "LANGSMITH_DEPRECATED_LIST_RUNS" });
    ...
    async *readThread(props) {
        (0, warn_js_1.warnOnce)("readThread() is deprecated and will be removed after Jan 31, 2027. " +
            "Use client.threads.listTraces() instead. " +
            "See https://docs.langchain.com/langsmith/smithdb-sdk-migration-threads#threads-list-traces for the migration guide.", { type: "DeprecationWarning", code: "LANGSMITH_DEPRECATED_READ_THREAD" });
    ...
    async listThreads(props) {
        (0, warn_js_1.warnOnce)("listThreads() is deprecated and will be removed after Jan 31, 2027. " +
            "Use client.threads.query() instead. " +
            "See https://docs.langchain.com/langsmith/smithdb-sdk-migration-threads#threads-query for the migration guide.", { type: "DeprecationWarning", code: "LANGSMITH_DEPRECATED_LIST_THREADS" });
    ...
    async shareRun(runId, { shareId } = {}) {
        (0, warn_js_1.warnOnce)("shareRun() is deprecated and will be removed after Jan 31, 2027. " +
            "Use client.runs.share.create() instead. " +
            "See https://docs.langchain.com/langsmith/smithdb-sdk-migration-feedback#share-and-read-public-runs for the migration guide.", { type: "DeprecationWarning", code: "LANGSMITH_DEPRECATED_SHARE_RUN" });
        const data = {
            run_id: runId,
    ...
    async unshareRun(runId) {
        (0, warn_js_1.warnOnce)("unshareRun() is deprecated and will be removed after Jan 31, 2027. " +
            "Use client.runs.share.delete() instead. " +
            "See https://docs.langchain.com/langsmith/smithdb-sdk-migration-feedback#share-and-read-public-runs for the migration guide.", { type: "DeprecationWarning", code: "LANGSMITH_DEPRECATED_UNSHARE_RUN" });
        (0, _uuid_js_1.assertUuid)(runId);
        await this.caller.call(async () => {
            const res = await this._fetch(`${this.apiUrl}/runs/${runId}/share`, {
                method: "DELETE",
    ...
    async readRunSharedLink(runId) {
        (0, warn_js_1.warnOnce)("readRunSharedLink() is deprecated and will be removed after Jan 31, 2027. " +
    ...
    async listSharedRuns(shareToken, { runIds, } = {}) {
        (0, warn_js_1.warnOnce)("listSharedRuns() is deprecated and will be removed after Jan 31, 2027. " +
    ...
    async createFeedback(runIdOrParams, keyArg, optionsArg) {
        const { runId = null, key, score, value, correction, comment, sourceInfo, feedbackSourceType = "api", sourceRunId, feedbackId, feedbackConfig, projectId, traceId, comparativeExperimentId, sessionId, startTime, extendTraceRetention, } = typeof runIdOrParams === "object" && runIdOrParams !== null
            ? runIdOrParams
    ...
    async addRunsToAnnotationQueue(queueId, runs) {
        ...
        if (!allStrings) {
            ...
            (0, warn_js_1.warnOnce)("Passing run IDs as strings to addRunsToAnnotationQueue() is deprecated and will be removed after Jan 31, 2027. " +
                "Use RunKey[] instead. " +
